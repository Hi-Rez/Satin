//
//  MultipleTextureComputeSystem.swift
//  Satin
//
...
open class MultipleTextureComputeSystem {
    public var label: String = "Satin Multiple Texture Compute Encoder"
    ...
    private func dispatch(_ computeEncoder: MTLComputeCommandEncoder, _ pipeline: MTLComputePipelineState) {
        guard let texture = self.texture[0] else { return }
        #if os(iOS) || os(macOS)
