Pod::Spec.new do |spec|
  ...
  spec.public_header_files    = ["Sources/*.h", "Sources/**/*.h"]

  spec.source_files           = "Sources/Satin/*.h", "Sources/Satin/**/*.{h,c,m,swift}"
  spec.exclude_files          = "Sources/Satin/Pipelines/**/**/*.metal"
